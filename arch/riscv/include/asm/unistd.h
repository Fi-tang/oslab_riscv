...
#define SYSCALL_SEM_INIT 56     // newly added!
#define SYSCALL_SEM_UP  57      // newly added!
#define SYSCALL_SEM_DOWN 58     // newly added!
#define SYSCALL_SEM_DESTROY 59  // newly added!
